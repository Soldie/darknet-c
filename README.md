...
(Note: Not all images in the images.tar.gz are labelled in the labels.tar.gz, for ex, yield_122.txt is empty. Hence use only the list of images in [this link](http://guanghan.info/download/training_list.txt)
